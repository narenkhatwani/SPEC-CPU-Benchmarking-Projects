...
echo may not be re-installed. See the documentation for convert_to_development
echo at https://www.spec.org/%SUITE%/Docs/utility.html#convert
echo:
goto :EOF
...
if not defined SPEC_NOCHECK (
    ...
    echo the destination device, as well as how anti-virus software is configured,
    echo this may take anywhere from 1 minute to more than 20 minutes.
...
echo Now testing the tools installation.  Depending on the speed of the destination
echo device, as well as how anti-virus software is configured,
echo this may take anywhere from 1 minute to more than 20 minutes.
echo Please be patient.
...
echo set SHRC_PRECOMPILED=yes >> %bat_cwd%
echo call .\shrc.bat >> %bat_cwd%
echo exit /B         >> %bat_cwd%
...
echo.
echo. Depending on the speed of the source and destination devices,
echo. as well as how anti-virus software is configured,
echo. this may take anywhere from 1 minute to more than 20 minutes.
echo. Please be patient.
echo.
goto :EOF
